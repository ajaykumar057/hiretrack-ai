...
const navItems = [
  ...
  { icon: Globe, label: 'LinkedIn CRM', path: '/linkedin-crm' },
  { icon: FileText, label: 'Resumes', path: '/resume' },
  { icon: FileSearch, label: 'Resume Intelligence', path: '/resume-intelligence' },
